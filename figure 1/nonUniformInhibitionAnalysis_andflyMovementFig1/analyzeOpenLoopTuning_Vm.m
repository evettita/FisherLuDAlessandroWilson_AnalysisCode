...
% to also look at persistance of effect of a bar flash on Vm....
%
...
possibleTrials_1barBefore = [1:30];
...
% %% Plot the fly movement as a function of trial number, for movement analysis
% % looks at fly movement for these trial
% [ aveAngularSpeed,  aveForwardSpeed, trialNums ] = findAveFlyMovementByTrial( trialFilesList );
% 
...
% % Plot Vm bar response
 deltaVm = false;
 meanResponse = plotHeatMapRFs( membraneVoltageResp,  stimulus, exptInfo, trialNum , deltaVm );
